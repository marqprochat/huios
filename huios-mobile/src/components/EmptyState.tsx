...
export function EmptyState({ title, message, icon = 'inbox', accessibilityLabel = 'Agenda vazia' }: EmptyStateProps) {
  return <View className="items-center rounded-card border border-slate-200 bg-surface px-5 py-8">
    <View className="mb-3 rounded-full bg-primary-soft p-3"><AppIcon name={icon} accessibilityLabel={accessibilityLabel} color="#135bec" size={28} /></View>
