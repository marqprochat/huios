...
export default function NovoAlunoForm({ classes }: { classes: any[] }) {
    const [state, action] = useActionState(createAluno, { success: false, message: '' });
    ...
    return (
        <form action={action} className="space-y-8">
            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <MaskedInput mask="phone" type="tel" id="phone" name="phone" className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all dark:text-white" placeholder="(11) 99999-9999" />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <MaskedInput mask="cpf" type="text" id="cpf" name="cpf" required className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all dark:text-white" placeholder="000.000.000-00" />
                    </div>

                    <div className="space-y-2">
                        <label htmlFor="birthDate" className="text-sm font-bold text-slate-700 dark:text-slate-300">Data de Nascimento</label>
                        <input type="date" id="birthDate" name="birthDate" className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all dark:text-white" />
                    </div>

                    <div className="space-y-2">
                        <label htmlFor="maritalStatus" className="text-sm font-bold text-slate-700 dark:text-slate-300">Estado Civil</label>
                        <select id="maritalStatus" name="maritalStatus" className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all dark:text-white">
            ...
            <div className="pt-6 border-t border-slate-100 dark:border-slate-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        ...
                        <input type="text" id="conversionTime" name="conversionTime" className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all dark:text-white" placeholder="Ex: 5 anos" />
                    </div>

                    <div className="space-y-2">
                        <label htmlFor="churchName" className="text-sm font-bold text-slate-700 dark:text-slate-300">Qual igreja você frequenta?</label>
                        <input type="text" id="churchName" name="churchName" className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all dark:text-white" placeholder="Ex: Igreja Conviva" />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <input type="text" id="churchMembershipTime" name="churchMembershipTime" className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all dark:text-white" placeholder="Ex: 3 anos" />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-6 pt-1">
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="isBaptized" value="true" className="w-4 h-4 text-primary border-slate-300 focus:ring-primary" />
                                <span className="text-sm text-slate-700 dark:text-slate-300">Sim</span>
                            </label>
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="isBaptized" value="false" defaultChecked className="w-4 h-4 text-primary border-slate-300 focus:ring-primary" />
                    ...
                    <div className="space-y-2">
                        ...
                        <input type="text" id="baptismTime" name="baptismTime" className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all dark:text-white" placeholder="Ex: 2 anos" />
                    </div>
                </div>
            </div>
            ...
            <div className="pt-6 border-t border-slate-100 dark:border-slate-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <label htmlFor="howKnewHuios" className="text-sm font-bold text-slate-700 dark:text-slate-300">Como conheceu o Huios?</label>
                        <select id="howKnewHuios" name="howKnewHuios" className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all dark:text-white">
                            <option value="">Selecione...</option>
                    ...
                    <div className="space-y-2">
                        ...
                        <input type="number" id="enrollmentFee" name="enrollmentFee" step="0.01" min="0" className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all dark:text-white" placeholder="0,00" />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-6 pt-1">
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="didConvivaCourse" value="true" className="w-4 h-4 text-primary border-slate-300 focus:ring-primary" />
                                <span className="text-sm text-slate-700 dark:text-slate-300">Sim</span>
                            </label>
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="didConvivaCourse" value="false" defaultChecked className="w-4 h-4 text-primary border-slate-300 focus:ring-primary" />
                                <span className="text-sm text-slate-700 dark:text-slate-300">Não</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <input type="text" id="convivaCourseDetails" name="convivaCourseDetails" className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all dark:text-white" placeholder="Ex: Curso de Liderança, EBD..." />
                    </div>
                </div>
            </div>
