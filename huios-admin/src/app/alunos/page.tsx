    ...
    return (
        <div className="max-w-[1600px] mx-auto p-4 lg:p-8 space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">Alunos</h2>
                    <p className="text-slate-500 dark:text-slate-400">Gerencie os alunos do seminário</p>
                </div>
                <Link href="/alunos/novo" className="bg-primary text-white px-5 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 hover:opacity-90 transition-all shadow-lg shadow-primary/20">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse min-w-[600px]">
                        ...
                        <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                            {alunos.length === 0 ? (
                                <tr>
                                    <td colSpan={4} className="px-6 py-8 text-center text-slate-500">Nenhum aluno cadastrado.</td>
                                </tr>
                            ) : null}
                            {alunos.map(aluno => (
