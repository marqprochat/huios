            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 md:p-8">
                <form action={updateCourseWithId} className="space-y-6" encType="multipart/form-data">
                    ...
                    <div className="space-y-2">
                        ...
                        <select id="modality" name="modality" defaultValue={(curso as any).modality ?? 'POR_NOTA'} className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all dark:text-white">
