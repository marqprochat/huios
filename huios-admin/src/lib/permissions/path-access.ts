...
const pathPermissions: PathPermission[] = [
  ...
  { pattern: '/equipe/:id/editar', requirement: { kind: 'permission', permission: 'equipe.editar' } },
  { pattern: '/equipe/novo', requirement: { kind: 'permission', permission: 'equipe.criar' } },
  { pattern: '/equipe', requirement: { kind: 'permission', permission: 'equipe.visualizar' } },
  { pattern: '/funcoes/:id', requirement: { kind: 'permission', permission: 'funcoes.visualizar' } },
  { pattern: '/funcoes', requirement: { kind: 'permission', permission: 'funcoes.visualizar' } },
